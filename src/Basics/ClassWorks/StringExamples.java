...
public class StringExamples {
    public static void main(String[] args) {
       ...
       /* String text2 = text1;*/
        ...
        String input2 = "Basics.ClassWorks.Input text";
        String inputCombined = input1.concat(input2);
        System.out.println(inputCombined);

        //COMPARING STRINGS
        String texts1 = "Basics.ClassWorks.Test ";
        String texts2 = "Basics.ClassWorks.Test";
        ...
        String speakingText = "This is Basics.ClassWorks.Test";
        ...
        //Basics.ClassWorks.Test comment
